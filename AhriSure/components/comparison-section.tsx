export function ComparisonSection() {
  ...
  return (
    // <section id="comparison" className="bg-gradient-to-b from-[#f5fcfb] to-white p-4 py-20 md:py-32">
    <section id="comparison" className="bg-[#f5fcfb] py-20 md:py-32">
      <div className="container mx-auto px-6">
        ...
        <div className="overflow-hidden max-w-6xl mx-auto rounded-2xl bg-white shadow-lg">
          <table className="w-full">
            ...
            <tbody>
              {comparisons.map((comparison, index) => (
                <tr key={index} className={`border-b last:border-0 border-white ${index%2 == 0 ? "bg-white" : "bg-[#f2faf8]"}`}>
