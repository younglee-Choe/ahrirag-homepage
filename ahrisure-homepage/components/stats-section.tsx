    ...
    <section className="py-20 bg-[#379188] text-white select-none">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-18 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="md:hidden h-px bg-gray-300/50 mx-15 my-0" />
          ...
          <div className="text-center">
            ...
            <p className="font-extralight opacity-90 leading-relaxed text-sm">
              세심하게 맞춤 상품을 지원해,{' '}
              <span className="font-medium md:font-bold text-white">95%</span>에 이르는
              <br className="block md:hidden" />고객분들의 높은 만족도로 이어지고 있습니다.
              <br />
              신뢰받는 상담 파트너가 되어드립니다.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="font-extralight opacity-90 leading-relaxed text-sm">
              ...
              <span className="font-medium md:font-bold text-white">30%</span>나
              <br className="block md:hidden" />더 자연스럽게 늘어, 설계사님의 영업 성과가 한층 더
              빛나고 있습니다.
            </p>
          </div>
        </div>
